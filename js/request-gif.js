...
function fetchAndDisplayGif(event) {
    ...
    if (robot != 5) {
        ...
        $.ajax({
            dataType: 'jsonp',
            url: "https://api.giphy.com/v1/gifs/random" + "?api_key=" + params.api_key + "&tag=" + params.tag, // TODO where should this request be sent?
            //url: "",
